...
char read[45][40],gl[45],gr[45][40],temp,templ[45],tempr[45][40],*ptr,temp2[45],dfa[45][45];
char variables[45]={'\0'}, terminals[45]={'\0'};
char slr[30][30][25]={'\0'};
char foll[40];
int len_var, len_ter; 
struct states
{
	char lhs[45],rhs[45][40];
	int n;
}I[45];
